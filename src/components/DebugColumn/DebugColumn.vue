...
const { species, background, professions, languages, description, size, equipment, features } = useCharacter()
  ...
  <article class="Column">
    <cyan-card>
      ...
      <section class="dataTable">
        ...
        <p class="TypeBody2">
          <strong>Ammatti:</strong>
        </p>
        <p class="TypeBody2">
          {{ background }}
        </p>
        <p class="TypeBody2">
          <strong>Osaamiset:</strong>
        </p>
        <p class="TypeBody2">
          {{ professions }}
        </p>
        ...
        <p class="TypeBody2">
          <strong><cyan-code>features</cyan-code></strong>
        </p>
        <p class="TypeBody2">
          {{ features }}
        </p>
